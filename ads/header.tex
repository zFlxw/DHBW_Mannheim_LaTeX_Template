...
%% IMPORTS
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage[a4paper, margin=\seitenrand,foot=1cm]{geometry}	% Seitenränder und Abstände
...
\usepackage{tocbasic}
\usepackage{listings}
\usepackage{scrhack}	% Hilft gegen manche Warnungen
% \usepackage{showframe}	% Zum debuggen 
